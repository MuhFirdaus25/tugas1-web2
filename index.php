...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            <img src="logo1.png" alt="" width="7%">
          <h1 class="navbar-brand" href="#">BUAHSHOP.ID</h1>
         ...
         <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
           ...
           <div class="carousel-inner">
             <div class="carousel-item active">
               <img src="buah1.jpg" class="d-block w-100" alt="...">
               <div class="carousel-caption d-none d-md-block">
                <h5> Slide label</h5>
               </div>
             </div>
             <div class="carousel-item">
               <img src="buah11.jpg" class="d-block w-100" alt="...">
               <div class="carousel-caption d-none d-md-block">
                <h5>Slide label</h5>
              </div>
             </div>
             <div class="carousel-item">
               <img src="buah111.jpg" class="d-block w-100" alt="...">
               <div class="carousel-caption d-none d-md-block">
                 <h5>Slide label</h5>
...
<div class="modal fade" id="modal<?=$row['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <footer>
        <div class="container">
            <small>Copyright &copy; - Muh. Firdaus, All Rights Reserver</small>
        </div>
    </footer>
